package study.com.feedbackdemo.imagepicker.activity;
...
import study.com.feedbackdemo.bean.ImageFolder;
import study.com.feedbackdemo.bean.ImageItem;
import study.com.feedbackdemo.imagepicker.DataHolder;
import study.com.feedbackdemo.imagepicker.ImageDataSource;
import study.com.feedbackdemo.imagepicker.ImagePicker;
import study.com.feedbackdemo.imagepicker.adapter.ImageFolderAdapter;
import study.com.feedbackdemo.imagepicker.adapter.ImageRecyclerAdapter;
import study.com.feedbackdemo.imagepicker.util.BitmapUtil;
import study.com.feedbackdemo.imagepicker.view.FolderPopUpWindow;
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            if (checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new ImageDataSource(this, null, this);  //通过使用Loader加载本地数据
            } else {
